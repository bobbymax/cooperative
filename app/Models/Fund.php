 ...
 * @OA\Property(property="sub_budget_head_id", type="integer", example="14"),
 ...
 * @OA\Property(property="budget_year", type="integer" , example="2021"),
 * @OA\Property(property="funded", type="boolean", example="True"),
